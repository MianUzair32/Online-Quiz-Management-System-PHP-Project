        ...
        <div class="modal-body">
          ...
          <div class="row">
            ...
            <div class="col-md-5 developer">
              <a href="#"  title="Find on Facebook" class="developer">M.Uzair Zulfiqar</a>
    ...
    <div class="row row-cols-1 row-cols-md-3 g-4 my-4  mx-5 px-5">
      <div class="col ">
        <div class="card h-100">
          ...
          <div class="card-body">
            <h5 class="card-title">M.Uzair Zulfiqar</h5>
      ...
      <div class="col ">
        <div class="card h-100">
          <img src="image/fuyiz.jpg" class="card-img-top" alt="...">
          <div class="card-body">
            <h5 class="card-title">M.Fuyiz Khan</h5>
            <p class="card-text">Front-End Designer & UI/UX Designer.</p>
            <a href="contact.php" class="btn btn-info">Contact Us</a>
          </div>
        </div>
      </div>
